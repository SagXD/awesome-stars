...
- [Sanqui/2048-gb](https://github.com/Sanqui/2048-gb) - Game Boy and Master System port of 2048
...
- [bitmono-project/BitMono](https://github.com/bitmono-project/BitMono) - Obfuscator for .NET and Mono, with a customizable engine for building your own obfuscators.
...
- [3fbaea00/MinecraftESP](https://github.com/3fbaea00/MinecraftESP) - Internal ESP hack in C# for Java Minecraft
...
- [Sinflower/BookLiveRipper](https://github.com/Sinflower/BookLiveRipper) - Qt-Based tool to download full novels from Booklive.jp
...
- [Lecrapouille/gdcef](https://github.com/Lecrapouille/gdcef) - [Godot Plugin][Version 0.20.0][Functional] Chromium Embedded Framework Webview for Godot 4
...
- [TheForceEngine/TheForceEngine](https://github.com/TheForceEngine/TheForceEngine) - Modern "Jedi Engine" replacement supporting Dark Forces, mods, and in the future Outlaws.
...
- [ZerafinaCSS/neos](https://github.com/ZerafinaCSS/neos) - A customizable site skin that gives AO3 a slightly modernized, semi-flat look and enhances the user experience.
- [VKEA/PrideCSS](https://github.com/VKEA/PrideCSS) - BEM-compliant SCSS library for adding pride flags as gradient backgrounds.
...
- [carloshdrp/anilist-css](https://github.com/carloshdrp/anilist-css) - A CSS library to customize your Anilist profile
...
- [enrique-lozano/Monekin](https://github.com/enrique-lozano/Monekin) - Track your money, not your data. Monekin is a fast, simple, offline-first personal finance app — 100% open source, zero ads, striking design.
...
- [kra-mo/Sly](https://github.com/kra-mo/Sly) - Mirrored from https://codeberg.org/Sly/Sly
...
- [dominickdupuy/Parasite](https://github.com/dominickdupuy/Parasite) - Rogue-like single player game w/ Godot game engine
- [m-canton/godot-scene-manager](https://github.com/m-canton/godot-scene-manager) - Scene Manager Plugin for Godot.
- [FahadLive/BlastOff](https://github.com/FahadLive/BlastOff) - 🚀 BlastOff is a casual endless runner game featuring vector graphics. Built using Godot v4.6.3
...
- [Rhythia/sound-space-plus](https://github.com/Rhythia/sound-space-plus) - [Old Rhythia, now unmaintained] Rhythm-based aim game
...
- [Eldeston/Super-Duper-Vanilla](https://github.com/Eldeston/Super-Duper-Vanilla) - A shader pack created to convey the style of the cancelled Super Duper Graphics Pack and other popular Minecraft titles.
...
- [BalintCsala/VPT](https://github.com/BalintCsala/VPT) - Shaderpack for the vanilla pipeliine of Minecraft
...
- [WorldObservationLog/wrapper-manager](https://github.com/WorldObservationLog/wrapper-manager) - A tool for managing multiple Wrapper instances
...
- [tranarchy/nicotine](https://github.com/tranarchy/nicotine) - Minecraft utility mod for anarchy servers (26.3)
...
- [WangTingZheng/mcp940](https://github.com/WangTingZheng/mcp940) - Source code of minecraft 1.12
- [NamiDevelopment/nami-public](https://github.com/NamiDevelopment/nami-public) - Free and Open-Source client for anarchy servers such as 2b2t.org
...
- [wagenknecht/backloggd-android-app](https://github.com/wagenknecht/backloggd-android-app) - This is an Android application for the website backloggd.com. It provides a native-feeling experience with its own navigation, improved UI/UX, and integrated Android features.
...
- [hugecatdev/dmenu-android](https://github.com/hugecatdev/dmenu-android) - dmenu is a fast and lightweight menu for Android that works on accessibility service shortcuts
...
- [Potion-Studios/Oh-The-Biomes-Weve-Gone](https://github.com/Potion-Studios/Oh-The-Biomes-Weve-Gone) - Sequel to Oh The Biomes You'll Go, this mod adds a variety of new overworld biomes to minecraft
...
- [Timefall-Development/MCDungeonsWeapons](https://github.com/Timefall-Development/MCDungeonsWeapons) - Bringing the weapons and tools of Minecraft Dungeons to Minecraft
...
- [TiangongCraft/Tenet](https://github.com/TiangongCraft/Tenet) - Minecraft Forge Hybrid server implementing the Spigot/Bukkit API, formerly known as Thermos/Cauldron/MCPC+
...
- [Team-Hibiscus/NaturesSpiritFabric](https://github.com/Team-Hibiscus/NaturesSpiritFabric) - 
...
- [XeraPlugins/8b8tCoreLegacy](https://github.com/XeraPlugins/8b8tCoreLegacy) - Folia Core Plugin for 8b8t and Anarchy Servers
...
- [Leawind/Third-Person](https://github.com/Leawind/Third-Person) - A smooth third person perspective mod for Minecraft
...
- [MongusOrg/SolidPressure](https://github.com/MongusOrg/SolidPressure) - Minecraft client based on earth
...
- [moechakucha/BTAModList](https://github.com/moechakucha/BTAModList) - A GUI of loaded Babric mods, for Better than Adventure
- [moechakucha/BTAExampleMod-babric](https://github.com/moechakucha/BTAExampleMod-babric) - BTA Example Mod but with Babric
...
- [mysticflute/ani-list-unlimited](https://github.com/mysticflute/ani-list-unlimited) - A collection of user scripts for https://anilist.co.
...
- [ThomazPom/Moz-Ext-UltimaDark](https://github.com/ThomazPom/Moz-Ext-UltimaDark) - A web extension that uses exclusive, unique, unconventional, and advanced techniques to bring dark mode on every site.
...
- [lgbt-sh/lgbt-sh-v1](https://github.com/lgbt-sh/lgbt-sh-v1) - Free lgbt.sh sub-domain registration service
...
- [AppFuton/Futon](https://github.com/AppFuton/Futon) - Manga reader for Android
...
- [jeeneo/dejpeg](https://github.com/jeeneo/dejpeg) - Compression artifact remover
...
- [darriousliu/PiPixiv](https://github.com/darriousliu/PiPixiv) - 一个使用Compose Multiplatform开发的第三方Pixiv客户端，支持国内直连
...
- [T31n/YagniLauncher](https://github.com/T31n/YagniLauncher) - Stock Android Launcher From Scratch
...
- [Jeremiznoo/FlipperDroid](https://github.com/Jeremiznoo/FlipperDroid) - FlipperDroid is a Kotlin-based Android app that turns your smartphone into a powerful mobile cybersecurity toolkit, emulating Flipper Zero features like NFC, RFID, Bluetooth, BadUSB, and more.
...
- [aload0/AppLock](https://github.com/aload0/AppLock) - Powerful privacy tool to lock apps from intruders
...
- [sergio-sastre/ComposablePreviewScanner](https://github.com/sergio-sastre/ComposablePreviewScanner) - A Compose Multiplatform friendly library to help auto-generate screenshot tests from Composable Previews (e.g. Android, Glance) with any screenshot testing library: JVM-based (i.e. Paparazzi, Roborazz
...
- [thePolocloud/polocloud](https://github.com/thePolocloud/polocloud) - PoloCloud is the simplest and easiest Cloud for Minecraft
...
- [Omico/CurrentActivity](https://github.com/Omico/CurrentActivity) - Current Activity is an open-source Android app built with Google's recommended app architecture, serving as a public reference implementation for learning, experimenting with, and evolving modern Andr
...
- [yatinj30/MacMonium](https://github.com/yatinj30/MacMonium) - A fully functional Harmonium for macOS. Uses the hinge/lid velocity to simulate air pressure and volume.
...
- [Fuzss/puzzles-lib](https://github.com/Fuzss/puzzles-lib) - Why is it called Puzzles? That's the puzzle.
...
- [GlitchFisher/GlitchFisher](https://github.com/GlitchFisher/GlitchFisher) - 
...
- [itsyashvardhan/is-a.co](https://github.com/itsyashvardhan/is-a.co) - 🌐 Grab your own subdomain for free  Follow the steps listed below to get your own subdomain!
...
- [milenakos/cat-bot](https://github.com/milenakos/cat-bot) - Discord Cat Bot Source Code
- [minerva-archive/worker](https://github.com/minerva-archive/worker) - Distributed Minerva Worker
...
- [Nudin/mpv-script-directory](https://github.com/Nudin/mpv-script-directory) - A machine-readable directory of scripts and other tools for mpv.
...
- [dylanpdx/vxtiktok](https://github.com/dylanpdx/vxtiktok) - Web service that fixes TikTok links embedding on Discord
...
- [wotakumoe/kaguya](https://github.com/wotakumoe/kaguya) - JSON generator for Cubari.moe
...
- [devnoname120/google-play-book-downloader](https://github.com/devnoname120/google-play-book-downloader) - Download and decrypt books purchased on Google Play Books without text reflowing
...
- [Zehina/Webtoon-Downloader](https://github.com/Zehina/Webtoon-Downloader) - A fast CLI for downloading chapters of Webtoons
...
- [bbtufty/seadexarr](https://github.com/bbtufty/seadexarr) - Sync Anime on Sonarr and Radarr with SeaDex
...
- [rainbowpigeon/sublime-text-4-patcher](https://github.com/rainbowpigeon/sublime-text-4-patcher) - Python 3 patcher for Sublime Text v4107-4214 Windows x64
...
- [kcrca/clean](https://github.com/kcrca/clean) - 
...
- [aldwin7894/project-cyan](https://github.com/aldwin7894/project-cyan) - My personal web app
...
- [lichess-org/leroyjenkins](https://github.com/lichess-org/leroyjenkins) - Follow ban logs to manage ip sets in nftables
...
- [ratatui/bevy_ratatui](https://github.com/ratatui/bevy_ratatui) - A rust crate for using Ratatui in a Bevy application.
...
- [flanker/bilibili-dark-mode](https://github.com/flanker/bilibili-dark-mode) - A Chrome/Edge/Firefox extension to turn your bilibili.com into dark mode
- [e18lab/NHApp](https://github.com/e18lab/NHApp) - nhentai app is a modern and lightweight android and pc client for nhentai
- [rRoler/bookmarklets](https://github.com/rRoler/bookmarklets) - Various simple bookmarklets
...
- [Lanred-Dev/justreddit](https://github.com/Lanred-Dev/justreddit) - A simple no-dependency Reddit API wrapper for getting post, comment, and subreddit metadata.
...
- [aidendotgg/aiden.gg](https://github.com/aidendotgg/aiden.gg) - Personal Portfolio Website
...
- [CriticalFlaw/flawhud](https://github.com/CriticalFlaw/flawhud) - Custom HUD for Team Fortress 2 with a focus on dark themed colors.
...
- [zhanziyang/vue-croppa](https://github.com/zhanziyang/vue-croppa) - A simple straightforward customizable mobile-friendly image cropper for Vue.
